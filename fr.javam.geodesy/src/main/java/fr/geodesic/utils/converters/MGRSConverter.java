...
public class MGRSConverter extends UTMConverter implements GeoCoordinate.Converter {
	...
	private class MGRS2Polar extends UTMConverter.UTM2Polar {
		...
		public GeoCoordinate.Spheric2D convertMGRUTMToLatLong(GeoCoordinate _coord) {
			...
			UTMConverter.LatZones lz = new UTMConverter.LatZones();
	...
	private class Polar2MGRS extends UTMConverter.Polar2UTM {
		public GeoCoordinate.Cartesian2D convertLatLonToMGRUTM(GeoCoordinate _wgs84) {
			...
			UTMConverter.validate(wgs84.getLatitude(), wgs84.getLongitude());
